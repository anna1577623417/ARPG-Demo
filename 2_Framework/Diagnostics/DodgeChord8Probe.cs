...
///
/// 启用：GameMain → Debug → Log Settings → Dodge Chord8 / SplitFrame
...
public static class DodgeChord8Probe
{
    ...
    public static bool IsEnabled => GameMainDebugSettings.DodgeChord8Log;
    ...
    /// <summary>213.6 — BodyFixed 屏感槽 + CharacterForward 位移时 LogicProjected 重选 Route。</summary>
